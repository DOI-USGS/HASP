...
statCd <- data_info$statistic_id[data_info$`Data Type` == "Daily" &
                                  data_info$parameter_code == parameterCd]
...
# Field GWL measured:
available_pcodes_f <- unique(data_info$parameter_code[data_info$`Data Type` == "Field"])

# Field GWL measured:
if(length(available_pcodes_f) == 0){
