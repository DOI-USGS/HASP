...
test_that("Kendall Seasonal Trend", {
  ...
  expect_true(24.2 == signif(test4$slope[1], digits = 3))
  expect_true(2.07 == signif(test4$slope[2], digits = 3))
...
test_that("trend segments",{
  ...
  expect_true(all(seg_df$x1 == as.Date(c("2012-05-19", "1978-09-16"))))
  expect_true(all(seg_df$x2 == as.Date(c("2022-05-18", "2022-05-18"))))
  ...
  expect_true(all(seg_df$x1 == c("2012-05-19", "1978-09-16")))
  expect_true(all(seg_df$x2 == c("2022-05-18", "2022-05-18")))
