...
#'
#' @param MainDir dir
#' @param FullSiteName name
#' @param dat data frame?
#' @param trendResults_i data frame?
#' @param trendResults_i2 data frame?
#' @param pc data frame?
#' 
#' @export
#' 
#' 
chlorideTimeseriesTable <- function(MainDir, FullSiteName, 
                                    dat, 
                                    trendResults_i,
                                    trendResults_i2, pc){
