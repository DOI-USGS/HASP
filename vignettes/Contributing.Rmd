...
Next, you'll need to set up a Personal Access Token. Go to [https://code.usgs.gov/-/user_settings/personal_access_tokens](https://code.usgs.gov/-/user_settings/personal_access_tokens) and create a new token selecting the api scope:
