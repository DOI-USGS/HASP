...
weekly_frequency_table(gw_level_dv,
                       parameterCd,
                       statCd)
```
...
<table>
<tr><td>
```{r weeklyFrequencyPlot, echo=FALSE}
weekly_frequency_plot(gw_level_dv, 
                      parameterCd, statCd, 
                      plot_title = "263819081585801 L -2701 ")
...
Weekly frequency analysis of daily maximum water level record
...
Statistics of maximum daily water level record
